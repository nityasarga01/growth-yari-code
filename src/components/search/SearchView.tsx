      ...
      <div className="mb-6">
        <div className="relative">
          ...
          <button
            ...
            className="absolute right-2 sm:right-4 top-1/2 transform -translate-y-1/2 flex items-center space-x-1 sm:space-x-2 px-2 sm:px-4 py-2 bg-brand-primary/10 text-brand-primary rounded-lg hover:bg-brand-primary/20 transition-colors text-sm sm:text-base"
          >
            ...
            <div className="p-4 sm:p-6">
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  className="flex-1 flex items-center justify-center space-x-1 px-2 sm:px-3 py-2 bg-brand-primary text-white rounded-lg text-xs sm:text-sm font-medium hover:bg-brand-secondary transition-colors"
                >
